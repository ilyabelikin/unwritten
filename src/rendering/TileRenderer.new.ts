...
export class TileRenderer {
  ...
  private createTileGraphic(hex: HexTile): Graphics {
    ...
    this.terrainRenderer.drawSideFaces(
      gfx,
      hex,
      expandedCorners,
      sideH,
  ...
  drawRoadsFromSettlements(
    ...
    this.roadRenderer.drawRoadsFromSettlements(
      this.roadGraphics,
      grid,
      settlements,
      worldMap,
  ...
  drawBuilding(hex: HexTile, allTiles: Iterable<HexTile>): void {
    ...
    if (hex.settlementId !== undefined) {
      this.settlementRenderer.drawSettlementConnections(
        gfx,
        hex,
        allTiles,
        corners,
  ...
  drawSettlementPerimeter(hex: HexTile, allTiles: Iterable<HexTile>): void {
    ...
    const corners = isoCorners(hex);
    this.settlementRenderer.drawSettlementPerimeter(
      gfx,
      hex,
      allTiles,
      corners,
